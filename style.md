...
Стили - это соглашения, определяющие качество нашего код. Термин стиль является не слишком полным, так как данное соглашение покрывают гораздо больше, чем просто форматирование исходного кода, c которым прекрасно справляется gofmt.
